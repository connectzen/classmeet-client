                                                            ...
                                                            <div>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                                                    {topic.lessons.map((lesson, lIdx) => {
                                                                        ...
                                                                        return (
                                                                            <div key={lesson.id} className="hover-card" style={{ borderRadius: 12, border: '1px solid rgba(139,92,246,0.45)', overflow: 'hidden', background: isLOpen ? 'transparent' : 'linear-gradient(135deg, #1a0a2e 0%, #2d1b4e 50%, #1e1040 100%)', boxShadow: isLOpen ? 'none' : '0 2px 12px rgba(139,92,246,0.22)' }}>
