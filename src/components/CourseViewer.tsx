                                                            ...
                                                            <div>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                                                    {topic.lessons.map((lesson, lIdx) => {
                                                                        ...
                                                                        return (
                                                                            <div key={lesson.id} className="hover-card" style={{ borderRadius: 12, border: '1px solid rgba(56,189,248,0.4)', overflow: 'hidden', background: isLOpen ? 'transparent' : 'linear-gradient(135deg, #0a2233 0%, #0e3347 50%, #092d40 100%)', boxShadow: isLOpen ? 'none' : '0 2px 12px rgba(56,189,248,0.15)' }}>
