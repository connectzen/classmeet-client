                                                            ...
                                                            <div>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                                                    {topic.lessons.map((lesson, lIdx) => {
                                                                        ...
                                                                        return (
                                                                            <div key={lesson.id} className="hover-card" style={{ borderRadius: 12, border: '1px solid rgba(99,102,241,0.5)', overflow: 'hidden', background: isLOpen ? 'transparent' : 'linear-gradient(135deg, #13123a 0%, #1e1c52 50%, #161445 100%)', boxShadow: isLOpen ? 'none' : '0 2px 14px rgba(99,102,241,0.22)' }}>
