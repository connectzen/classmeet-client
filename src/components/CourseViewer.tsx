                                                            ...
                                                            <div>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                                                    {topic.lessons.map((lesson, lIdx) => {
                                                                        ...
                                                                        return (
                                                                            <div key={lesson.id} className="hover-card" style={{ borderRadius: 12, border: '1px solid rgba(251,146,60,0.45)', overflow: 'hidden', background: isLOpen ? 'transparent' : 'linear-gradient(135deg, #1c1000 0%, #2e1a00 50%, #1f1200 100%)', boxShadow: isLOpen ? 'none' : '0 2px 12px rgba(251,146,60,0.18)' }}>
