                                                            ...
                                                            <div>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                                                    {topic.lessons.map((lesson, lIdx) => {
                                                                        ...
                                                                        return (
                                                                            <div key={lesson.id} className="hover-card" style={{ borderRadius: 12, border: '1px solid rgba(234,179,8,0.35)', overflow: 'hidden', background: 'linear-gradient(135deg, #2a1e00 0%, #3b2a00 50%, #261d00 100%)', boxShadow: '0 2px 10px rgba(234,179,8,0.12)' }}>
