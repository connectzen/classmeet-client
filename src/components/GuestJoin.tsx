        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg, #13151f)', display: 'flex', flexDirection: 'column', fontFamily: 'inherit' }}>
            ...
            <div style={{ flex: 1, position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 16px' }}>
                ...
                {!loading && (error || !session) && (
                    <div className="hover-card" style={{ maxWidth: 400, width: '100%', background: 'var(--surface-2, #242840)', borderRadius: 20, border: '1px solid rgba(239,68,68,0.3)', padding: 40, textAlign: 'center', boxShadow: '0 8px 40px rgba(0,0,0,0.3)' }}>
                ...
                {!loading && session && (
                    <div style={{ width: '100%', maxWidth: 680, display: 'flex', flexDirection: 'column', gap: 20 }}>
                        ...
                        {/* Name input */}
                        <div className="hover-card" style={{ background: 'var(--surface, #1c1f2e)', border: '1px solid rgba(255,255,255,0.10)', borderRadius: 16, padding: '20px 24px', boxShadow: '0 4px 24px rgba(0,0,0,0.2)' }}>
